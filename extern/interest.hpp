...
public: // Selectors
  ...
  **/
  ...
  /**
   * \brief Set Interest type to refresh PI
   * 
   * @param pushRefresh True when sending refresh PI
  **/
  Interest&
  setPushRefresh(const bool pushRefresh);
  ...
  **/
  ...
  /**
   * \brief Set Interest type to tainted probe Interest
   * 
   * @param probe tainted probe Interest if set to True
  **/
  Interest&
  setTainted(const bool tainted);

  /**
   * \brief Returns true in case of a tainted probe Interest
  **/
  bool
  isTainted() const;
